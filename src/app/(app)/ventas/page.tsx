    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Despachos a PY, armados a partir de big bags disponibles.</p>
        </div>
        <Link
          href="/ventas/nuevo"
              ...
              {saleLots.map((s) => {
                ...
                return (
                  <tr key={s.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-right font-mono text-slate-400">{bags.length}</td>
